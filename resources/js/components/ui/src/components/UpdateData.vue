      ...
      <v-card>
        <v-form ref="form">
              ...
              <v-row>
                <v-col cols="12">
                  <v-text-field
                    ...
                    type="password"
                    v-model="passNew"
                    :rules="[() => !!passNew && passNew.length > 8 || 'Ingrese una contraseña valida.']"
                  ></v-text-field>
                </v-col>
                <v-divider></v-divider>
                <v-col cols="12">
          ...
          <v-card-actions>
            <v-row>
                <v-col cols="12" sm="6">
                    <v-btn color="blue darken-1" text @click="cambiarData()">Aceptar</v-btn>
                </v-col>
                <v-col cols="12" sm="6">
                    <v-btn color="blue darken-1" text @click="changeChanges()">Cancelar</v-btn>
                </v-col>
            </v-row>
          </v-card-actions>
        </v-form>
